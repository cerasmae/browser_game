...
function playBall() {
    ...
    this.draw = function(name) {
        ...
        context.fillText(name, this.x - context.measureText(name).width / 2, this.y);
    }
}
...
function world() {
    ...
    case 1: //game
        for (var i = 0; i < balls.length; i++) {
            if (getHypothenuse(mouseX, mouseY, balls[i].x, balls[i].y ) <= characterRadius + balls[i].radius && mouseMoved) {
